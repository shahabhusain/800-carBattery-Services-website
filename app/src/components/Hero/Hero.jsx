  ...
  return (
    <div className=' text-white'>
        <div className='relative'>
               <Image className=' w-full h-screen object-cover' src={hero} alt='image'/>
      <div className=' bg-[#000000BD] absolute top-0 w-full h-screen'></div>
       <div className=' absolute top-52 md:left-36 left-6 right-6 md:right-0 md:max-w-[645px] flex flex-col gap-y-6'>
